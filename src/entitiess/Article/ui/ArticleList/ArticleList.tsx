...
function ArticleList(props: ArticleListProps) {
	const { view, limit, target, articles, isLoading, className, onScrollEnd, isVirtuoso = false } = props
		...
		if (isVirtuoso) {
			return (
				<VirtuosoGrid
					...
					style={{
						height: "calc(var(--vh) * 100 - 60px - 117px)",
						width: "100%",
					}}
			...
			return (
				<div className={classNames(s.articles, {}, [s[view]])}>
					{!isLoading
	...
	return <div className={classNames(className)}>{renderArticles()}</div>
}
